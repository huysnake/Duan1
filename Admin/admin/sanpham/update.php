...
<body>
    <div class="container">
        ...
        <div class="box-right">
            ...
            <form action="index.php?act=updatesp" class="form" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="form-group">
                        <label for="">Tên sản phẩm</label>
                        <input type="text" name="ten_sp" id="" value="<?php echo $sp['name'] ?>">
                    </div>
                    <div class="form-group">
                        <label for="">Số lượng</label>
                        <input type="text" name="soluong" id="" value="<?php echo $sp['soluong'] ?>">
                    </div>
                    <div class="form-group">
                        <label for="">Đơn giá</label>
                        <input type="text" name="price" id="" value="<?php echo $sp['price'] ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="luotxem" id="" value="<?php echo $sp['luotxem'] ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="mota" id="" value="<?php echo $sp['mota'] ?>">
                    </div>
                </div>
                <div class="act-sp">

    ...
    <div class="container">
        ...
        ?>
            <div class="product">
                ...
                <div class="price">
                    <p>Giá niêm yết :</p><strong><?php echo $sp['price'] ?> vnđ</strong>
                </div>
                <div class="price-real">
                    <p>Giá bán :</p><strong><?php echo $sp['price'] ?> vnđ</strong>
                </div>
